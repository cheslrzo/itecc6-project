...
const Habits = () => {
  ...
  return (
    <div>
      ...
      {/* Habit List Header */}
      <div className="grid grid-cols-5 font-semibold border-b pb-2 mb-2 gap-4">
        <span>Habit</span>
        <span>Streak</span>
        <span>Frequency</span>
        <span>Goal</span>
      ...
      {habits.map((habit) => (
        <div
          key={habit.id}
          className="grid grid-cols-5 items-center py-2 border-t gap-4"
        >
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => {
                    ...
                    if (/^\d*$/.test(raw)) setGoalDays(raw === '' ? 0 : parseInt(raw));
                  }}
                  className="w-full px-3 py-2 border rounded"
                  min={1}
                />
